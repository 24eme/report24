		...
		<div class="container">
      		<div class="py-4">
				...
				<strong class="float-right text-dark">
					...
					<br />
					<span class="font-weight-normal"><a href="mailto:<?php echo $clientConf['FACTURE_EMAILS'] ?>"><span class="oi oi-envelope-closed"></span> <?php echo $clientConf['FACTURE_EMAILS'] ?></span></a>
					<?php endif; ?>
				</strong>
      		</div>
